...
public interface AdminOpenApi {
    ...
    @Operation(summary = "Buscar administrador por e-mail")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Administrador encontrado"),
            @ApiResponse(responseCode = "404", description = "Administrador não encontrado")
    })
    ResponseEntity<?> buscarPorEmail(
            @Parameter(description = "E-mail do administrador", required = true) @RequestParam String email
    );
